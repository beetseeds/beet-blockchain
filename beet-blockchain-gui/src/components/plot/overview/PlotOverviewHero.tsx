...
import { CardHero, Link } from '@beet/core';
import { PlotHero as PlotHeroIcon } from '@beet/icons';
      ...
      <Grid xs={12} md={6} lg={4} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {'Plots are allocated space on your hard drive used to farm and earn beet. '}
              <Link target="_blank" href="https://github.com/beet-Network/beet-blockchain/wiki/Network-Architecture">Learn more</Link>
            </Trans>
          </Typography>
          <Button
