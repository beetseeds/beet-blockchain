...
import { Card, FormatLargeNumber, Link, Loading, TooltipIcon, Flex } from '@beet/core';
import {
  unix_to_short_date,
  hex_to_array,
  arr_to_hex,
...
export default function Block() {
  ...
  const baseFarmerReward = mojo_to_beet(calculateBaseFarmerReward(blockRecord.height));
    ...
    >
      <Card
        title={(
          <BlockTitle>
            <Trans>
              Block at height {blockRecord.height} in the beet
              blockchain
            </Trans>
          </BlockTitle>
        )}
