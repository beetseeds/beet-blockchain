...
required to run a [Timelord](https://github.com/beet-Network/beet-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/beet-Network/beet-blockchain/blob/main/install-timelord.sh)
