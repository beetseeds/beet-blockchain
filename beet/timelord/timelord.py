...
from beet.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from beet.timelord.iters_from_block import iters_from_block
from beet.timelord.timelord_state import LastState
from beet.timelord.types import Chain, IterationType, StateType
from beet.types.blockchain_format.classgroup import ClassgroupElement
from beet.types.blockchain_format.reward_chain_block import RewardChainBlock
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[beetServer] = None
