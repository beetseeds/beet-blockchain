...
from beet.consensus.coinbase import create_pool_coin, create_farmer_coin
from beet.consensus.block_rewards import calculate_pool_reward, calculate_base_farmer_reward
from beet.consensus.cost_calculator import NPCResult

"""
The purpose of this file is to provide a lightweight simulator for the testing of beetlisp smart contracts.
...
There is also a provided NodeClient object which implements many of the methods from beet.rpc.full_node_rpc_client
