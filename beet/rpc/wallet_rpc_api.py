...
from beet.cmds.init_funcs import check_keys
from beet.consensus.block_rewards import calculate_base_farmer_reward
from beet.pools.pool_puzzles import SINGLETON_MOD_HASH, create_p2_singleton_puzzle
from beet.pools.pool_wallet import PoolWallet
from beet.pools.pool_wallet_info import create_pool_state, FARMING_TO_POOL, PoolWalletInfo, PoolState
...
from beet.util.bech32m import decode_puzzle_hash, encode_puzzle_hash
from beet.util.byte_types import hexstr_to_bytes
from beet.util.ints import uint32, uint64
from beet.util.keychain import bytes_to_mnemonic, generate_mnemonic
from beet.util.path import path_from_root
from beet.util.ws_message import WsRpcMessage, create_payload_dict
from beet.wallet.cc_wallet.cc_wallet import CCWallet
from beet.wallet.derive_keys import master_sk_to_singleton_owner_sk
from beet.wallet.rl_wallet.rl_wallet import RLWallet
from beet.wallet.derive_keys import master_sk_to_farmer_sk, master_sk_to_pool_sk, master_sk_to_wallet_sk
from beet.wallet.did_wallet.did_wallet import DIDWallet
from beet.wallet.trade_record import TradeRecord
from beet.wallet.transaction_record import TransactionRecord
from beet.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from beet.wallet.util.trade_utils import trade_record_to_dict
from beet.wallet.util.transaction_type import TransactionType
from beet.wallet.util.wallet_types import WalletType
from beet.wallet.wallet_info import WalletInfo
from beet.wallet.wallet_node import WalletNode
...
class WalletRpcApi:
    ...
    async def _state_changed(self, *args) -> List[WsRpcMessage]:
        ...
        return [create_payload_dict("state_changed", data, "beet_wallet", "wallet_ui")]
    ...
    async def _check_key_used_for_rewards(
        ...
        farmer_target = config["farmer"].get("xbt_target_address")
        pool_target = config["pool"].get("xbt_target_address")
        found_farmer = False
        found_pool = False
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from beet.pools.pool_wallet_info import initial_pool_state_from_dict
