...
from beet.clvm.singleton import SINGLETON_LAUNCHER
from beet.consensus.block_rewards import calculate_pool_reward
from beet.consensus.coinbase import pool_parent_id
from beet.pools.pool_wallet_info import PoolState, LEAVING_POOL, SELF_POOLING
...
from beet.wallet.puzzles.singleton_top_layer import puzzle_for_singleton
...
def solution_to_extra_data(full_spend: CoinSpend) -> Optional[PoolState]:
    ...
    if num_args == 2:
        ...
        # This is referred to as p1 in the beetlisp code
