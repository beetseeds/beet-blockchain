...
from beet.cmds.configure import configure_cmd
from beet.cmds.farm import farm_cmd
from beet.cmds.init import init_cmd
from beet.cmds.keys import keys_cmd
from beet.cmds.netspace import netspace_cmd
from beet.cmds.plots import plots_cmd
from beet.cmds.show import show_cmd
from beet.cmds.start import start_cmd
from beet.cmds.stop import stop_cmd
from beet.cmds.wallet import wallet_cmd
...
@click.group(
    help=f"\n  Manage beet blockchain infrastructure ({__version__})\n",
    epilog="Try 'beet start node', 'beet netspace -d 192', or 'beet show -s'",
...
@cli.command("version", short_help="Show beet version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs beet daemon")
@click.pass_context
def run_daemon_cmd(ctx: click.Context) -> None:
    from beet.daemon.server import async_run_daemon
    import asyncio
