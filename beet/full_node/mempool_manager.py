...
from beet.full_node.mempool_check_conditions import mempool_check_conditions_dict, get_name_puzzle_conditions
...
from beet.util.clvm import int_from_bytes
...
class MempoolManager:
    def __init__(self, coin_store: CoinStore, consensus_constants: ConsensusConstants):
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 xbt per block, or about 0.00005 xbt for two
        # spends.
