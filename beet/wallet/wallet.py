...
from beet.consensus.cost_calculator import calculate_cost_of_program, NPCResult
...
from beet.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    DEFAULT_HIDDEN_PUZZLE_HASH,
    calculate_synthetic_secret_key,
    puzzle_for_pk,
    solution_for_conditions,
)
from beet.wallet.puzzles.puzzle_utils import (
...
from beet.wallet.secret_key_store import SecretKeyStore
from beet.wallet.sign_coin_spends import sign_coin_spends
...
class Wallet:
    ...
    async def create_spend_bundle_relative_beet(self, beet_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if beet_amount < 0:
            utxos = await self.select_coins(abs(beet_amount), exclude)
        else:
        ...
        beet_amount = spend_value + beet_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": beet_amount}]
