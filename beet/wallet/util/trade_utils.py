...
from beet.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "beet" in cc_discrepancies:
                    cc_discrepancies["beet"] = cc_discrepancies["beet"] + diff
                else:
                    cc_discrepancies["beet"] = diff
