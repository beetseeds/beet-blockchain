...
from beet.types.blockchain_format.program import Program, SerializedProgram

wallet_program_files = set(
    [
        "beet/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "beet/wallet/puzzles/cc.clvm",
        "beet/wallet/puzzles/beetlisp_deserialisation.clvm",
        "beet/wallet/puzzles/rom_bootstrap_generator.clvm",
        "beet/wallet/puzzles/generator_for_single_coin.clvm",
        "beet/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "beet/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "beet/wallet/puzzles/lock.inner.puzzle.clvm",
        "beet/wallet/puzzles/p2_conditions.clvm",
        "beet/wallet/puzzles/p2_delegated_conditions.clvm",
        "beet/wallet/puzzles/p2_delegated_puzzle.clvm",
        "beet/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "beet/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "beet/wallet/puzzles/p2_puzzle_hash.clvm",
        "beet/wallet/puzzles/rl_aggregation.clvm",
        "beet/wallet/puzzles/rl.clvm",
        "beet/wallet/puzzles/sha256tree_module.clvm",
        "beet/wallet/puzzles/singleton_top_layer.clvm",
        "beet/wallet/puzzles/did_innerpuz.clvm",
        "beet/wallet/puzzles/decompress_puzzle.clvm",
        "beet/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "beet/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "beet/wallet/puzzles/block_program_zero.clvm",
        "beet/wallet/puzzles/test_generator_deserialize.clvm",
        "beet/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "beet/wallet/puzzles/p2_singleton.clvm",
        "beet/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "beet/wallet/puzzles/pool_member_innerpuz.clvm",
        "beet/wallet/puzzles/singleton_launcher.clvm",
        "beet/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["beet/wallet/puzzles/create-lock-puzzlehash.clvm", "beet/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "beet/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to beet/wallet/puzzles, but not added to `wallet_program_files`
        """
