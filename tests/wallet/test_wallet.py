...
from beet.protocols.full_node_protocol import RespondBlock
from beet.server.server import beetServer
from beet.simulator.simulator_protocol import FarmNewBlockProtocol, ReorgProtocol
from beet.types.peer_info import PeerInfo
from beet.util.ints import uint16, uint32, uint64
...
class TestWalletSimulator:
    ...
    #         outbound: List[WSbeetConnection] = wallet.server.get_outgoing_connections()
