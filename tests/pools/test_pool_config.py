...
from beet.pools.pool_config import PoolWalletConfig
from beet.util.config import load_config, save_config, create_default_beet_config
...
def test_pool_config():
    ...
    create_default_beet_config(test_root, ["config.yaml"])
