...
from beet.wallet.puzzles.p2_conditions import puzzle_for_conditions
from beet.wallet.puzzles import singleton_top_layer
from beet.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - beet.pools.pool_puzzles.py
    - beet.wallet.puzzles.pool_member_innerpuz.clvm
    - beet.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
