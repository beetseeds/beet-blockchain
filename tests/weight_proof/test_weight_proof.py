...
from beet.server.start_full_node import SERVICE_NAME
...
from beet.consensus.pot_iterations import calculate_iterations_quality
from beet.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
